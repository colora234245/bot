...
run: async (client, message, args, embed, prefix) => { 
    ...
    {
    message.react(red)
    message.lineReply(`\`${prefix}kayıt <@West/ID> <Isim> <Yaş>\``).then(x=>x.delete({timeout:5000})) 
    return }
...
Üyesinin önceki isimlerine \`.isimler <@West/ID>\` komutuyla bakarak kayıt işlemini gerçekleştirmeniz önerilir.
    `)
